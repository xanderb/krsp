...
echo Form::open('', array('id' => 'decree-form'));
?>
<fieldset>
<?php
if(isset($legend)){
...
?>
    <dl>
        <dt><?=Form::label('value_decree', 'Значение для решения по материалам')?></dt>
        <dd><?=Form::input(
                'value',
        ...
        <dt><?=Form::label('text_decree', 'Решение по материалам')?></dt>
        <dd><?=Form::textarea(
                'text',
    ...
    <div class="form-actions">
        <?php echo Form::button('submit', 'Сохранить', array('class' => 'btn btn-primary', 'id' => 'decree-save')); ?>
    </div>
